...
import { calcSVGNodesXYForWeek } from "../common/nodePositions";
...
const _epicsByTeamID = new Map<string, Epic[]>([
    ...
    ["A3", [
        ...
        { ID: "8", TeamID: "A3", Name: "Epic SME2", ExpectedStartPeriod: 7, Size: EpicSizes.Small, Upstreams: ["1-3"] },
        { ID: "9", TeamID: "A3", Name: "Epic SME3", ExpectedStartPeriod: 4, Size: EpicSizes.Small, Upstreams: ["2", "6"] },
        { ID: "10-1", TeamID: "A3", Name: "Epic SME4", ExpectedStartPeriod: 4, Size: EpicSizes.Small },
        { ID: "10-2", TeamID: "A3", Name: "Epic SME4", ExpectedStartPeriod: 4, Size: EpicSizes.Medium },
    ]],
    ["A4", [
        //     { ID: "11", TeamID: "A4", Name: "Epic M1", ExpectedStartPeriod: 4, Size: EpicSizes.Small },
        { ID: "12", TeamID: "A4", Name: "Epic M2", ExpectedStartPeriod: 6, Size: EpicSizes.Small, Upstreams: ["9"] },
        { ID: "13", TeamID: "A4", Name: "Epic M3", ExpectedStartPeriod: 3, Size: EpicSizes.Small, Upstreams: ["1-4"] },
    ]],
    // ["A5", [
    ...
    ["A6", [
        ...
        { ID: "17", TeamID: "A6", Name: "Epic CRM3", ExpectedStartPeriod: 4, Size: EpicSizes.Small, Upstreams: ["6"] },
        { ID: "18", TeamID: "A6", Name: "Epic CMR4", ExpectedStartPeriod: 5, Size: EpicSizes.Medium, Upstreams: ["17"] },
    ...
    // ]],
    ["A8", [
        { ID: "26-0", TeamID: "A8", Name: "Epic CN0", ExpectedStartPeriod: 6, Size: EpicSizes.Small, Upstreams: ["13"] },
        { ID: "26-1", TeamID: "A8", Name: "Epic CN1", ExpectedStartPeriod: 8, Size: EpicSizes.Small, Upstreams: ["26-0"] },
        { ID: "27", TeamID: "A8", Name: "Epic CN2", ExpectedStartPeriod: 9, Size: EpicSizes.Small, Upstreams: ["12"] },
    ]],
]);
